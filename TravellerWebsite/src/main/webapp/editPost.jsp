...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <div class="image">
            <img src="asset/images/character14.jpg" alt="">
        </div>
        ...
        <form action="EditPostServlet?pid=<%=p.getPid() %>" method="post" enctype="multipart/form-data" id="post-form">
      ...
      <option hidden value="">Select Category</option>
       <%
            ...
            <h3 class="mt-3">Title</h3>
                <input style="width:100%;" type="text" placeholder="Title" name="poTitle" value="<%=p.getpTitle() %>" required>
                
                
            </div>
             <div class="inputBox">
             <h3 class="mt-3">Location</h3>
                <input style="width:100%;" type="text" placeholder="Location" name="poLocation" value="<%=p.getpLocation() %>" required>
           
            </div>
            <h3 class="mt-3">Description</h3>
            <textarea placeholder="Description"  id="" cols="30" rows="10" name="poDesc" required><%=p.getpDesc() %></textarea>
            <input type="submit" class="btn" value="Edit Post">
        </form>
...
$(document).ready(function(){
	$("form").submit(function(){
		swal("Done!", "Post Edited Successfully....!", "success");
